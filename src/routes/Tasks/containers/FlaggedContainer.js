...
class FlaggedContainer extends React.Component {
  componentWillMount () {
    const {
      tasksRequested,
      projectsRequested,
  ...
  render () {
    ...
    const filteredTasks = tasks.filter(t => !t.completed && t.flagged)
    ...
    return (
      <div>
        ...
        <div className={cx(classes.topPad, ' ui masthead vertical segment ', { leftPad: sidebarExpanded })}>
          <h1 className="ui header">Flagged</h1>
...
export default connect(mapStateToProps, mapActionCreators)(FlaggedContainer)
