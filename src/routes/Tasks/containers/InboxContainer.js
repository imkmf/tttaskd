...
class TasksContainer extends React.Component {
  ...
  render () {
    ...
    const filteredTasks = tasks.filter(t => !t.completed && !t.context_id && !t.project_id)
    ...
    return (
      <div>
        ...
        <div className={cx(classes.topPad, ' ui masthead vertical segment ', { leftPad: sidebarExpanded })}>
          <h1 className="ui header">Inbox</h1>
...
export default connect(mapStateToProps, mapActionCreators)(TasksContainer)
